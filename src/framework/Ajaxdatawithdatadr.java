...
public class Ajaxdatawithdatadr {
	FirefoxDriver driver;
	@BeforeMethod
	public void setup()
	{
		driver=new FirefoxDriver();
	driver.get("https://care.ideacellular.com/");
...
WebElement ajax=driver.findElement(By.xpath("//*[@id='erroeHolder']/label"));
String actajax=null;
...
FileOutputStream f1=new FileOutputStream("D:\\selenium rahul\\myselenium\\src\\com\\rahul\\resultexcelfile\\ajax.xlsx");
wb.write(f1);
f1.close();
