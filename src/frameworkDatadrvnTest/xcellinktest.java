...
String expurl=r.getCell(1).getStringCellValue();
	if(acturl.equals(expurl))
	  {
		r.createCell(3).setCellValue("paseed");
		}
	else
	{
...
FileOutputStream f1=new FileOutputStream("D:\\selenium rahul\\myselenium\\src\\com\\rahul\\resultexcelfile\\rr.xlsx");
wb.write(f1);
f1.close();
}
